...
class TestContentObfuscation(unittest.TestCase):
    ...
    def test_obfuscate_and_save_zew(self):
        ...
        obfuscated_content = self.obfuscator.obfuscate(
        ...
        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="zeroWidthCharacter", file_format="pdf"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        self.text_saver.save_text("./output/zwc_default.pdf", obfuscated_content)

        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="zeroWidthCharacter", file_format="docx"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
    ...
    def test_obfuscate_and_save_diacritical(self):
        ...
        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="diacritical", file_format="html"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        self.text_saver.save_text("./output/diac_default.html", obfuscated_content)

        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="diacritical", file_format="pdf"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        self.text_saver.save_text("./output/diac_default.pdf", obfuscated_content)

        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="diacritical", file_format="docx"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
    ...
    def test_obfuscate_and_save_homo(self):
        ...
        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="homoglyph", file_format="html"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        self.text_saver.save_text("./output/homo_default.html", obfuscated_content)

        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="homoglyph", file_format="pdf"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        self.text_saver.save_text("./output/homo_default.pdf", obfuscated_content)

        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="homoglyph", file_format="docx"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
    ...
    def test_obfuscate_and_save_bidi(self):
        ...
        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="bidi", file_format="html"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        self.text_saver.save_text("./output/bidi_default.html", obfuscated_content)

        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="bidi", file_format="pdf"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        self.text_saver.save_text("./output/bidi_default.pdf", obfuscated_content)

        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="bidi", file_format="docx"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        ...
        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="bidi", modality="heavy", file_format="pdf"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        self.text_saver.save_text("./output/bidi_heavy.pdf", obfuscated_content)

        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="bidi", modality="heavy", file_format="html"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
        self.text_saver.save_text("./output/bidi_heavy.html", obfuscated_content)

        obfuscated_content = self.obfuscator.obfuscate(
            content, target, obfuscation_technique="bidi", modality="heavy", file_format="docx"
        )
        self.assertNotIn("email@example.com", obfuscated_content)
