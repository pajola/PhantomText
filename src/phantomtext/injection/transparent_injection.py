    ...
    def __init__(self, modality="default", file_format="pdf"):
        ...
        if file_format == "pdf" or file_format == "html":
            ...
            # Modality not valid, raise error
                ...
                raise ValueError(
                    f"Modality {modality} is not valid. Valid modality is 'default' (background color injection ), 'opacity-0' (opacity set to 0) or 'opacity-close-to-zero' (opacity=0.1)"
                )
            ...
            if modality == "default":
                ...
                raise ValueError(
                    f"Modality {modality} is not valid. Valid modality is 'default' for docx (background color injection ) or 'vanish' (opacity set to 0)"
                )
    ...
    def apply(
        ...
        if self.file_format == "pdf":
            ...
            if self.modality == "default":
                ...
                new_tag["style"] = (
                    f"color: {background_color}; background-color: {background_color};"
                )
            elif self.modality == "opacity-0":
                new_tag["style"] = "opacity: 0;"
            elif self.modality == "opacity-close-to-zero":
                new_tag["style"] = "opacity: 0.1;"
